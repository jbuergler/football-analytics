...
On every metric that mattered, Spain were the better team throughout the tournament. They generated more xG per match (2.65 vs 2.45), conceded less than half England's xG against (0.67 vs 1.25), and pressed higher at every stage of the tournament. The @tbl-verdict showing the seven-metrics side by side further highlights that. Moreover, in the final the gap in chances created was significant. Spain created 2.14 xG from 23 shots, while England only attempted 8 shots (0.88 xG) and the last shot of the game coming in the 68th minute. Looking at these conventional metrics, Spain deserved to win.
